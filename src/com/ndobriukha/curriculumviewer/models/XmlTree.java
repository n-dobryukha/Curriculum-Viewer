...
/**
 * Given a filename or a name and an input stream, this class generates a JTree
 * representing the XML structure contained in the file or stream. Parses with
 * DOM then copies the tree structure (minus text and comment nodes).
 */
...
public class XmlTree extends JTree {
	...
	private static DefaultMutableTreeNode makeRootNode(InputStream in) {
		try {
			...
			Element rootElement = (Element)document.getElementsByTagName("Students").item(0);
